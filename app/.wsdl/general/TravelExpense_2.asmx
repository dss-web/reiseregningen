<?xml version="1.0" encoding="UTF-8"?><wsdl:definitions xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:tns="http://makingwaves.no/travelExp/" targetNamespace="http://makingwaves.no/travelExp/">
    ...
    <s:schema elementFormDefault="qualified" targetNamespace="http://makingwaves.no/travelExp/">
      ...
      <s:complexType name="TravelExpenseVO">
        <s:sequence>
          ...
          <s:element maxOccurs="1" minOccurs="0" name="travelAllowances" type="tns:TravelAllowancesVO"/>
      ...
      <s:complexType name="TravelAllowancesVO">
        <s:sequence>
          <s:element maxOccurs="1" minOccurs="1" name="admin_godtgj_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="admin_godtgj_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_domestic_below5h_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_domestic_below5h_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_domestic_5_9h_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_domestic_5_9h_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_domestic_9_12h_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_domestic_9_12h_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_domestic_over12h_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_domestic_over12h_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_international_6_12h_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_international_6_12h_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_international_over12h_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="nonight_international_over12h_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="overnight_domestic_8_12h_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="overnight_domestic_8_12h_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="overnight_domestic_over12h_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="overnight_domestic_over12h_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="overnight_international_1_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="overnight_international_1_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="overnight_international_2_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="overnight_international_2_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="ulegitimert_domestic_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="ulegitimert_domestic_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="ulegitimert_domestic_hotel_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="ulegitimert_domestic_hotel_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="ulegitimert_international_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="ulegitimert_international_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_car_below9000km_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_car_below9000km_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_car_over9000km_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_car_over9000km_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_homework_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_homework_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_passengers_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_passengers_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="0" name="dedicated_other_name" type="s:string"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_other_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="dedicated_other_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="0" name="beyond28days_cost_SDcode" type="s:string"/>
          <s:element maxOccurs="1" minOccurs="0" name="beyond28days_cost_TTcode" type="s:string"/>
          <s:element maxOccurs="1" minOccurs="0" name="beyond28days_cost_M" type="s:string"/>
          <s:element maxOccurs="1" minOccurs="1" name="beyond28days_cost_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="beyond28days_cost_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="0" name="beyond28days_nattillegg_SDcode" type="s:string"/>
          <s:element maxOccurs="1" minOccurs="0" name="beyond28days_nattillegg_TTcode" type="s:string"/>
          <s:element maxOccurs="1" minOccurs="0" name="beyond28days_nattillegg_M" type="s:string"/>
          <s:element maxOccurs="1" minOccurs="1" name="beyond28days_nattillegg_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="beyond28days_nattillegg_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="other_other_name" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="other_other_nrof" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="other_other_rate" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="totalof_amount" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="pull_without_overnight_amount" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="pull_with_overnight_amount" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="brutto_reiseregning_amount" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="brutto_reiseregning_kontering" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="brutto_reiseregning_code2" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="brutto_reiseregning_code3" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="brutto_reiseregning_code4" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="0" name="reiseforskudd_name" type="s:string"/>
          <s:element maxOccurs="1" minOccurs="1" name="reiseforskudd_amount" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="netto_belop_amount" type="s:double"/>
        </s:sequence>
      </s:complexType>
      ...
      <s:element name="RunTestAndGetIdResponse">
        <s:complexType>
          <s:sequence>
            <s:element maxOccurs="1" minOccurs="0" name="RunTestAndGetIdResult" type="s:string"/>
          </s:sequence>
        </s:complexType>
      </s:element>
    </s:schema>
  </wsdl:types>
  <wsdl:message name="RunTestAndGetIdSoapIn">
    <wsdl:part element="tns:RunTestAndGetId" name="parameters">
    </wsdl:part>
  </wsdl:message>
  ...
  <wsdl:message name="RunTestAndGetIdSoapOut">
    <wsdl:part element="tns:RunTestAndGetIdResponse" name="parameters">
    </wsdl:part>
  </wsdl:message>
...
<wsdl:documentation>Clean server-side memory from old, no-more required data. Specify identifier returned by 'getTravelPdfAsStoredId' or other Data-Store method</wsdl:documentation>
    ...
    <wsdl:operation name="RunTestAndGetId">
<wsdl:documentation>Test method that returns sample pdf</wsdl:documentation>
      <wsdl:input message="tns:RunTestAndGetIdSoapIn">
    </wsdl:input>
      <wsdl:output message="tns:RunTestAndGetIdSoapOut">
    </wsdl:output>
    </wsdl:operation>
  </wsdl:portType>
  <wsdl:binding name="TravelExpenseSoap12" type="tns:TravelExpenseSoap">
    ...
    <wsdl:operation name="RunTestAndGetId">
      <soap12:operation soapAction="http://makingwaves.no/travelExp/RunTestAndGetId" style="document"/>
      <wsdl:input>
        <soap12:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="TravelExpenseSoap" type="tns:TravelExpenseSoap">
    ...
    <wsdl:operation name="RunTestAndGetId">
      <soap:operation soapAction="http://makingwaves.no/travelExp/RunTestAndGetId" style="document"/>
      <wsdl:input>
        <soap:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
