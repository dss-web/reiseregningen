<?xml version="1.0" encoding="UTF-8"?><wsdl:definitions xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:tns="http://makingwaves.no/travelExp/" targetNamespace="http://makingwaves.no/travelExp/">
    ...
    <s:schema elementFormDefault="qualified" targetNamespace="http://makingwaves.no/travelExp/">
      ...
      <s:complexType name="TravelExpenseVO">
        <s:sequence>
          ...
          <s:element maxOccurs="1" minOccurs="0" name="travelAllowances" type="tns:TravelAllowanceVO"/>
      ...
      <s:complexType name="TravelVO">
        <s:sequence>
          ...
          <s:element maxOccurs="1" minOccurs="0" name="travelNumber" type="s:string"/>
        </s:sequence>
      </s:complexType>
      <s:complexType name="TravelAllowanceVO">
        <s:sequence>
          <s:element maxOccurs="1" minOccurs="0" name="adm_allowance" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="1" name="accomodation" type="s:boolean"/>
          <s:element maxOccurs="1" minOccurs="1" name="domestic" type="s:boolean"/>
          <s:element maxOccurs="1" minOccurs="0" name="allowance" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="allowance_international" type="tns:ArrayOfRateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="nighttariff_domestic" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="nighttariff_domestic_hotel" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="nighttariff_international" type="tns:ArrayOfRateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="allowance_28days" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="nighttariff_28days" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="car_distance1" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="car_distance2" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="car_passengers" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="car_otherrates" type="tns:RateVO"/>
          <s:element maxOccurs="1" minOccurs="1" name="netamount" type="s:double"/>
        </s:sequence>
      </s:complexType>
      <s:complexType name="RateVO">
        <s:sequence>
          <s:element maxOccurs="1" minOccurs="1" name="num" type="s:double"/>
      ...
      <s:complexType name="TravelSpecificationVO">
        <s:sequence>
          ...
          <s:element maxOccurs="1" minOccurs="1" name="from_timezone" type="s:double"/>
          <s:element maxOccurs="1" minOccurs="1" name="to_timezone" type="s:double"/>
        </s:sequence>
      </s:complexType>
      <s:complexType name="AnySpecificationAggregateVO">
        <s:sequence>
          ...
          <s:element maxOccurs="1" minOccurs="1" name="which_specification_used" type="s:double"/>
        </s:sequence>
      </s:complexType>
      ...
      <s:complexType name="TravelAccomodationVO">
        <s:sequence>
          ...
          <s:element maxOccurs="1" minOccurs="0" name="cost" type="tns:CostVO"/>
          <s:element maxOccurs="1" minOccurs="0" name="actual_cost" type="tns:CostVO"/>
        </s:sequence>
      </s:complexType>
      ...
      <s:element name="getTravelObjectFromXml">
        <s:complexType>
          <s:sequence>
            <s:element maxOccurs="1" minOccurs="0" name="xmlFileBytes" type="s:base64Binary"/>
          </s:sequence>
        </s:complexType>
      </s:element>
      <s:element name="getTravelObjectFromXmlResponse">
        <s:complexType>
          <s:sequence>
            <s:element maxOccurs="1" minOccurs="0" name="getTravelObjectFromXmlResult" type="tns:TravelExpenseVO"/>
          </s:sequence>
        </s:complexType>
      </s:element>
      ...
      <s:element name="getTravelObjectFromXmlAsStoredIdResponse">
        <s:complexType>
          <s:sequence>
            <s:element maxOccurs="1" minOccurs="0" name="getTravelObjectFromXmlAsStoredIdResult" type="tns:TravelExpenseVO"/>
          </s:sequence>
        </s:complexType>
      </s:element>
  ...
  <wsdl:message name="getTravelObjectFromXmlAsStoredIdSoapIn">
    <wsdl:part element="tns:getTravelObjectFromXmlAsStoredId" name="parameters">
    </wsdl:part>
  </wsdl:message>
  ...
  <wsdl:message name="getTravelObjectFromXmlSoapIn">
    <wsdl:part element="tns:getTravelObjectFromXml" name="parameters">
    </wsdl:part>
  </wsdl:message>
  ...
  <wsdl:message name="getTravelObjectFromXmlAsStoredIdSoapOut">
    <wsdl:part element="tns:getTravelObjectFromXmlAsStoredIdResponse" name="parameters">
    </wsdl:part>
  </wsdl:message>
  ...
  <wsdl:message name="getTravelObjectFromXmlSoapOut">
    <wsdl:part element="tns:getTravelObjectFromXmlResponse" name="parameters">
    </wsdl:part>
  </wsdl:message>
...
<wsdl:documentation>Clean server-side memory from old, no-more required data. Specify identifier returned by 'getTravelPdfAsStoredId' or other Data-Store method</wsdl:documentation>
    ...
    <wsdl:operation name="getTravelObjectFromXml">
<wsdl:documentation>Load XML file data and intepret it as TravelExpenseVO serialized object</wsdl:documentation>
      <wsdl:input message="tns:getTravelObjectFromXmlSoapIn">
    </wsdl:input>
      <wsdl:output message="tns:getTravelObjectFromXmlSoapOut">
    </wsdl:output>
    </wsdl:operation>
    <wsdl:operation name="getTravelObjectFromXmlAsStoredId">
<wsdl:documentation>Load XML file data and intepret it as TravelExpenseVO serialized object</wsdl:documentation>
      <wsdl:input message="tns:getTravelObjectFromXmlAsStoredIdSoapIn">
    </wsdl:input>
      <wsdl:output message="tns:getTravelObjectFromXmlAsStoredIdSoapOut">
    </wsdl:output>
    </wsdl:operation>
...
<wsdl:documentation>Test method that returns sample pdf</wsdl:documentation>
  ...
  <wsdl:binding name="TravelExpenseSoap12" type="tns:TravelExpenseSoap">
    ...
    <wsdl:operation name="getTravelObjectFromXml">
      <soap12:operation soapAction="http://makingwaves.no/travelExp/getTravelObjectFromXml" style="document"/>
      <wsdl:input>
        <soap12:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="getTravelObjectFromXmlAsStoredId">
      <soap12:operation soapAction="http://makingwaves.no/travelExp/getTravelObjectFromXmlAsStoredId" style="document"/>
      <wsdl:input>
        <soap12:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:binding name="TravelExpenseSoap" type="tns:TravelExpenseSoap">
    ...
    <wsdl:operation name="getTravelObjectFromXml">
      <soap:operation soapAction="http://makingwaves.no/travelExp/getTravelObjectFromXml" style="document"/>
      <wsdl:input>
        <soap:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
    ...
    <wsdl:operation name="getTravelObjectFromXmlAsStoredId">
      <soap:operation soapAction="http://makingwaves.no/travelExp/getTravelObjectFromXmlAsStoredId" style="document"/>
      <wsdl:input>
        <soap:body use="literal"/>
      </wsdl:input>
      <wsdl:output>
  ...
  <wsdl:service name="TravelExpense">
    <wsdl:port binding="tns:TravelExpenseSoap12" name="TravelExpenseSoap12">
      <soap12:address location="http://10.130.2.127/TravelExpWS/TravelExpense.asmx"/>
    </wsdl:port>
    <wsdl:port binding="tns:TravelExpenseSoap" name="TravelExpenseSoap">
      <soap:address location="http://10.130.2.127/TravelExpWS/TravelExpense.asmx"/>
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>