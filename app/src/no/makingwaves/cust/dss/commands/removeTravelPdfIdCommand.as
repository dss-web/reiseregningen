...
package no.makingwaves.cust.dss.commands
{
	...
	public class removeTravelPdfIdCommand implements ICommand, IResponder
	{ 
		// attributes ============================
		...
		private function errorOccoured(msg:String=""):void {
			...
			error.error_message = "Connection with webservice to delete pdf id failed!"
			error.error_message += "\n\n" + msg;
